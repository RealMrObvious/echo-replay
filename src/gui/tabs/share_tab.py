...
from PyQt6.QtCore import QEvent, QObject, pyqtSignal, pyqtSlot, QPropertyAnimation, QEasingCurve, QMimeData, QUrl
...
class ShareTab(QObject):
    ...
    @pyqtSlot(bool)
    def encoding_error(self, error_occured):
        if error_occured: print(f"An encoding error has occured")
